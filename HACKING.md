...
hidden if the `ghoulies_launcher_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ghoulies_launcher_DEVELOPER_MODE` to the configure
...
Runs the executable target `ghoulies_launcher_exe`.
